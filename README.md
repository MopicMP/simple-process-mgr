...
> Simple list, kill, monitor system processes

[![PyPI version](https://badge.fury.io/py/simple-process-mgr.svg)](https://pypi.org/project/simple-process-mgr/)
...
```bash
pip install simple-process-mgr
```
...
result = mgr("Hello World")

# Example 2: Batch processing
from simple_process_mgr import batch
